...
void RLZ::store_sequence(char *sequence, char *filename, Array *dest,
                         uint64_t length)
{
    uint64_t i;
    unsigned int v;
...
void RLZ::store_sequence(ifstream &infile, char *filename, Array *dest,
                         uint64_t length)
{
    uint64_t i;
    int c;
...
FactorWriterIndex::FactorWriterIndex(ofstream& outfile, Array *refseq,
